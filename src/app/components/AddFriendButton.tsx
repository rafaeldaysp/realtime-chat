...
export default function AddFriendButton() {
  ...
  const {
    ...
    setError,
    formState: { errors },
  } = useForm<AddFriendValidatorForm>({
    ...
    <form className="max-w-sm" onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="mt-2 flex gap-4">
        <input
          ...
          className="block w-full rounded-md border-0 bg-zinc-950 py-1.5 ring-1 ring-inset ring-purple-900 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-purple-500 sm:text-sm sm:leading-6"
        />
        <Button>Add</Button>
      </div>
